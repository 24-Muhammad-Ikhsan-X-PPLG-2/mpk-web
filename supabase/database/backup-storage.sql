...
CREATE POLICY "Enable delete, upload, and update wqc4c1_0" ON "storage"."objects" FOR INSERT TO "authenticated" WITH CHECK (("bucket_id" = 'seminar'::"text"));



CREATE POLICY "Enable delete, upload, and update wqc4c1_1" ON "storage"."objects" FOR SELECT TO "authenticated" USING (("bucket_id" = 'seminar'::"text"));



CREATE POLICY "Enable delete, upload, and update wqc4c1_2" ON "storage"."objects" FOR UPDATE TO "authenticated" USING (("bucket_id" = 'seminar'::"text"));



CREATE POLICY "Enable delete, upload, and update wqc4c1_3" ON "storage"."objects" FOR DELETE TO "authenticated" USING (("bucket_id" = 'seminar'::"text"));



CREATE POLICY "Enable read wqc4c1_0" ON "storage"."objects" FOR SELECT USING (("bucket_id" = 'seminar'::"text"));
